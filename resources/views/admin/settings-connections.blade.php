...
@section('title', 'Account settings - Connections | Sistem Kursus Komputer')
    ...
    <div class="col-md-12">
      <div class="nav-align-top">
        <ul class="nav nav-pills flex-column flex-md-row mb-6 gap-2 gap-lg-0">
          ...
          <li class="nav-item">
            <a class="nav-link" href="{{ route('dashboard.notifications-sistem') }}"
              ><i class="icon-base ri ri-notification-4-line icon-sm me-1_5"></i> Notifications</a
            >
          </li>
          <li class="nav-item">
            <a class="nav-link active" href="{{ route('dashboard.connections-sistem') }}"
          ...
          <div class="col-md-6 col-12">
            ...
            <div class="card-body">
                ...
                <div class="flex-grow-1 row align-items-center">
                  ...
                  <div class="col-5 text-end">
                    <button class="btn btn-outline-secondary btn-icon">
                      <i class="icon-base ri ri-link icon-22px"></i>
                    </button>
                  </div>
                </div>
              </div>
              <div class="d-flex mb-4 align-items-center">
                <div class="flex-shrink-0">
                  <img
                    src="{{ asset('assets/img/icons/brands/twitter-light.png') }}"
                    alt="twitter"
                    class="me-4"
                    height="32" />
                </div>
                <div class="flex-grow-1 row align-items-center">
                  <div class="col-7">
                    ...
                    <a href="https://x.com/Theme_Selection" target="_blank" class="small"
                      >@ThemeSelection</a
                    >
                  </div>
                  <div class="col-5 text-end">
