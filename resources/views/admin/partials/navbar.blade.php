...
<nav
  ...
  <div class="navbar-nav-right d-flex align-items-center justify-content-end" id="navbar-collapse">
    <!-- Menu Toggle for Desktop (Hide/Show Sidebar) -->
    <div class="navbar-nav align-items-center me-3 d-none d-xl-flex">
      <div class="nav-item">
        <a class="nav-link px-0" href="javascript:void(0);" id="menu-toggle-hidden" title="Toggle Sidebar">
          <i class="icon-base ri ri-side-bar-line icon-lg" id="menu-toggle-icon"></i>
        </a>
      </div>
    </div>
    <!-- /Menu Toggle -->
    ...
    <ul class="navbar-nav flex-row align-items-center ms-md-auto">
      ...
      <li class="nav-item navbar-dropdown dropdown-user dropdown">
        ...
        <ul class="dropdown-menu dropdown-menu-end">
          ...
          <li>
            <a class="dropdown-item" href="{{ route('dashboard.account-sistem') }}">
              <i class="icon-base ri ri-user-line icon-md me-3"></i>
              <span>My Profile</span>
            </a>
          </li>
          <li>
            <a class="dropdown-item" href="{{ route('dashboard.connections-sistem') }}">
